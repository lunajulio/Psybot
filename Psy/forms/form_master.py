...
class MasterPanel:
    ...
    def _setup_main_window(self):
        ...
        # Boton de diario
        diario = Button(self.window, text="Diario", font=FONT_BOLD)
        diario.place(relx=0.814, rely=0.09, relheight=0.15, relwidth=0.18)

        # Boton de Ansiedad
        ansiedad = Button(self.window, text="Test Ansiedad", font=FONT_BOLD)
        ansiedad.place(relx=0.814, rely=0.29, relheight=0.15, relwidth=0.18)

        # Boton de Depresion
        depresion = Button(self.window, text="Test Depresion", font=FONT_BOLD)
        depresion.place(relx=0.814, rely=0.48, relheight=0.15, relwidth=0.18)

        # Boton x
        xxx = Button(self.window, text="Diario", font=FONT_BOLD)
